                   ...
                   ppOutput   = \ str -> do
                     ...
                     send dbus msg 0 `catchDyn`
                       (\ (DBus.Error _name _msg) ->
                         return 0)
                     return ()
                 , ppTitle    = pangoColor "#8cd0d3" . shorten 50
                 , ppCurrent  = pangoColor "#c0bed1" . wrap "[" "]"
                 , ppVisible  = pangoColor "#dca3a3" . wrap "(" ")"
                 , ppHidden   = wrap " " " "
                 , ppUrgent   = pangoColor "#9ece9e"
                 }
